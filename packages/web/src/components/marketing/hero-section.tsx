    ...
    <section className="relative overflow-hidden bg-navy py-20 md:py-32">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="animate-fade-in mb-6 font-display text-4xl font-bold leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
            Kurumsal Kültürünüzü{' '}
            <span className="bg-gradient-to-r from-frosted to-icy bg-clip-text text-transparent">
              Veriye Dayalı
            </span>{' '}
            Yönetin
          </h1>

          <p className="animate-slide-up mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-white/60 md:text-xl">
