            ...
            <CardContent>
              {submitted ? (
                <div className="rounded-xl bg-primary/10 p-6 text-center">
                  <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-primary/20 text-xl text-primary">✓</div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email" name="email" type="email" required placeholder="isim@universite.edu.tr" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="institution">Kurum</Label>
                    <Input id="institution" name="institution" required placeholder="Üniversite adı" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="phone">Telefon (Opsiyonel)</Label>
                    <Input id="phone" name="phone" type="tel" placeholder="05XX XXX XX XX" />
                  </div>
                  <Button type="submit" className="w-full">Demo Talep Et</Button>
                </form>
              )}
            </CardContent>
          </Card>
